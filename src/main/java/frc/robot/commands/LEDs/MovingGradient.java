...
public class MovingGradient extends InstantCommand {

    /**
     * Sets LEDs to moving gradient between two colors with given delay
     */
    public MovingGradient(int HSVcolor1, int HSVcolor2, int delay) {
    ...
    protected void initialize() {
        Robot.led.setMovingGradient(_HSVcolor1, _HSVcolor2, _delay);
    }
