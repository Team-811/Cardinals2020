...
public class RainbowChase extends InstantCommand {

    /**
     * Sets LEDs to moving rainbow chase pattern with given delay
     */
    public RainbowChase(int delay) {
        _delay = delay;
    }
    ...
    protected void initialize() {
        Robot.led.setRainbowChase(_delay);
    }
