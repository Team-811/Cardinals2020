...
public class Pixy2Line {
	 ...
	 * 
	 * <p>
	 * Returned data should be retrieved from the cache with {@link #getVectors()},
	 * {@link #getIntersections()} or {@link #getBarcodes()}
	 * </p>
	 * 
	 ...
	 * 
	 * <p>
	 * {@link #getFeatures(byte, byte, boolean)} must be executed first to get the
	 * data actual from Pixy2
	 * </p>
	 * 
	 * @return Pixy2 Lines
	 */
